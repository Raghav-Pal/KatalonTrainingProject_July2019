...
WebUI.setText(findTestObject('WebObjects/Page_OrangeHRM/input_LOGIN Panel_txtUsername'), 'Admin')

WebUI.setEncryptedText(findTestObject('WebObjects/Page_OrangeHRM/input_Username_txtPassword'), 'hUKwJTbofgPU9eVlw/CnDQ==')

WebUI.click(findTestObject('WebObjects/Page_OrangeHRM/input_Password_Submit'))

WebUI.click(findTestObject('WebObjects/Page_OrangeHRM/b_Dashboard'))

WebUI.click(findTestObject('WebObjects/Page_OrangeHRM/b_Performance'))

WebUI.click(findTestObject('WebObjects/Page_OrangeHRM/b_Recruitment'))

WebUI.click(findTestObject('WebObjects/Page_OrangeHRM/b_Maintenance'))
